...
// TrendChart：月度總支出走勢，shadcn ChartContainer + Recharts AreaChart。
// props: data: [{ month, spend }]，ariaLabel
// 無資料時 Empty；附 visually-hidden 資料表（無障礙）。
...
// Y 軸刻度緊湊顯示（萬 / k）。input 為 cents（DB 已 migration），先除 100 還原為元。
